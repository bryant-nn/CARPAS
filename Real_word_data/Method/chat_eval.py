...
class ChatEval:
    ...
    def evaluate_relevance(self, ground_truth_aspects: list, generated_aspects: list) -> (int, str):
        """
        評估生成的主題 (aspects) 的相關性 (Relevance)。
...
def load_json_files(root_dir: str) -> list:
    # return ["../../Result/cot_prompt_with_csv_aspect/gemini_filtered_data_y2n2/o3-mini-2025-01-31/4_sample_11.json",
    #         "../../Result/cot_prompt_with_csv_aspect/gemini_filtered_data_y2n2/o3-mini-2025-01-31/4_sample_12.json",
    #         "../../Result/cot_prompt_with_csv_aspect/gemini_filtered_data_y2n2/o3-mini-2025-01-31/6_sample_36.json",
    #         "../../Result/cot_prompt_with_csv_aspect/gemini_filtered_data_y2n2/o3-mini-2025-01-31/7_sample_55.json",
    #         "../../Result/cot_prompt_with_csv_aspect/gemini_filtered_data_y2n2/o3-mini-2025-01-31/7_sample_71.json",
    #         "../../Result/cot_prompt_with_csv_aspect/gemini_filtered_data_y2n2/o3-mini-2025-01-31/8_sample_3.json",
    #         "../../Result/cot_prompt_with_csv_aspect/gemini_filtered_data_y2n2/o3-mini-2025-01-31/8_sample_28.json",
    #         "../../Result/cot_prompt_with_csv_aspect/gemini_filtered_data_y2n2/o3-mini-2025-01-31/8_sample_45.json"]
    """
