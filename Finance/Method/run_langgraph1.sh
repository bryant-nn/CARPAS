...
"python langgraph_guided.py --memory False --model o3-mini-2025-01-31 --y 0 --n 2"
"python langgraph_guided.py --memory False --model o3-mini-2025-01-31 --y 4 --n 4"
"python langgraph_guided.py --memory False --model o3-mini-2025-01-31 --y 4 --n 0"
"python langgraph_guided.py --memory False --model o3-mini-2025-01-31 --y 0 --n 4"
"python langgraph_guided.py --memory False --model o3-mini-2025-01-31 --y 6 --n 6"
